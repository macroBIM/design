...
<style>
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  #hsecplot,#channelplot,#ibeamplot,#spliceplot,#liftinglugplot,#box1cellplot{
      ...
      <div class="draw-card">
        ...
        <div class="draw-card-body">
          <div style="margin-bottom:20px;">
            ...
            <textarea class="form-input" id="sUserText" rows="4" style="width:100%;resize:vertical;font-size:12px;" placeholder="h,bt,bb,btsh,bcanh,bcan,t1,t2,t3,t4,t5,t6,tb,tw,bh,vh1,vh2,rwt,rwtin,rb,sl_tl,sl_tr,sl_b&#10;(end section)&#10;seg_length" onchange="putParams_box1cell('sUserText'); fdraw_box1cell();">6600,12000,6000,1500,1500,1500,300,300,600,600,300,300,840,500,200,200,100,300,200,400,-2,5,3
8000,12000,6000,1500,1500,1500,300,300,600,600,300,300,840,500,200,200,100,300,200,400,-2,5,3
5000</textarea>
          </div>

          <!-- 3-column header: Variable | Begin | End -->
          ...
          <div class="form-grid-3col">
            ...
            <div class="col-label">rwt <span style="font-weight:400;color:#94a3b8;font-size:11px;">(0 if not)</span></div>
            ...
            <div class="col-label">rwtin <span style="font-weight:400;color:#94a3b8;font-size:11px;">(0 if not)</span></div>
            ...
            <div class="col-label">rb <span style="font-weight:400;color:#94a3b8;font-size:11px;">(0 if not)</span></div>
          ...
          <div style="margin-top:16px;">
            <div class="form-grid" style="grid-template-columns:1fr;">
              <div class="form-group">
                <label class="form-label">Seg Length</label>
                <input class="form-input" type="number" id="dseg_leng" value="5000" onchange="fdraw_box1cell()">
              </div>
            </div>
          </div>

          <button class="btn-generate" onclick="odxf_box1cell.download('Box1Cell.dxf')"><i class="bi bi-download"></i> DXF DOWNLOAD</button>
        </div>
      </div>
...
function showPage(pageId){
  ...
  // 작도 페이지: 폼을 마운트한 뒤 작도 (컨테이너가 표시된 뒤여야 캔버스 크기 계산됨)
...
function mountDrawing(kind){
  ['hsection','channel','ibeam','splice','liftinglug','box1cell'].forEach(function(k){
    if(k!==kind){
      ...
      if(other) other.innerHTML='';   // 다른 작도 폼 제거
    }
  });
...
// 사이트 접속 시 기본 페이지: Dashboard (정적 콘텐츠라 별도 로딩 불필요, HTML 에서 active 지정됨)
</script>
</body>
</html>
