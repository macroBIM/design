...
function _bindNavigation() {
    ...
    function ensurePlate3d() {
        ...
        fr.src = 'https://macrobim.github.io/macroBIM/plate3d/embed.html?v=81';
        fr.title = 'PLATE3D';
        fr.allow = 'fullscreen';
    ...
    function ensureBeamFormula() {
        ...
        var sc = document.createElement('script');
        sc.src = 'https://cdn.jsdelivr.net/gh/macroBIM/macroBIM@ae801f2/beam_formula.js';   // Pages 가 멈춰 있는 동안의 우회 — 복구되면 위 주소로
