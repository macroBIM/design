...
function _bindNavigation() {
    ...
    function ensureIbeamTest(cb) { ensureRWModule('bim_ibeam_test.js?v=1', 'ibeamTest', cb); }
    function ensureBox1cellTest(cb) { ensureRWModule('bim_box1cell_test.js?v=1', 'box1cellTest', cb); }
