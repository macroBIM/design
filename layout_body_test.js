...
function initLayout(phpData) {
    ...
    /* ══ SIDEBAR ══ */
    + '<nav id="sidebar">'
    + '  <div class="sidebar-header"><div class="logo-info"><a href="http://www.macrobim.com" style="text-decoration:none;color:inherit;display:flex;align-items:center;gap:8px;">'
    + '    <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:28px;height:28px;flex-shrink:0;">'
    + '      <path d="M28 10 L44 19 L44 37 L28 46 L12 37 L12 19 Z" fill="#2563eb" opacity="0.1" stroke="#2563eb" stroke-width="1.5"/>'
    + '      <line x1="28" y1="28" x2="28" y2="46" stroke="#2563eb" stroke-width="1"/>'
    + '      <line x1="28" y1="28" x2="12" y2="19" stroke="#2563eb" stroke-width="1"/>'
    + '      <line x1="28" y1="28" x2="44" y2="19" stroke="#2563eb" stroke-width="1"/>'
    + '      <path d="M 48 28 A 22 22 0 0 1 28 50" stroke="#06b6d4" stroke-width="1.8" fill="none" stroke-linecap="round"/>'
    + '      <path d="M 26 48 L 28 52 L 31 49" stroke="#06b6d4" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round"/>'
    + '      <path d="M 8 28 A 22 22 0 0 1 28 6" stroke="#06b6d4" stroke-width="1.8" fill="none" stroke-linecap="round"/>'
    + '      <path d="M 30 8 L 28 4 L 25 7" stroke="#06b6d4" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round"/>'
    + '    </svg>'
    + '    <div>'
    + '      <span class="name" style="display:block;line-height:1.1;">macroBIM</span>'
    + '      <div style="width:100%;height:2px;background:linear-gradient(90deg,#2563eb,#06b6d4);border-radius:1px;margin-top:2px;"></div>'
    + '    </div>'
    + '  </a></div></div>'
    + '  <div class="nav-menu">'
