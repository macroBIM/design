...
function _createTemplates() {
    ...
    _addTemplate(root, 'tpl-draw-liftinglug', _HSCSS()
      ...
      + '      <div class="hs-batch-wrap"><div class="hs-batch-lbl">Batch Input (CSV) <span class="hs-batch-hint">lugW,lugH,baseH,outerR,innerR,padeyeR,lugT,padeyeT,ecc,bpW,bpT,bpL,spBotL,spTopL,spHL,spWL,spInsetL,spBotR,spTopR,spHR,spWR,spInsetR</span></div>'
      ...
      + '      <div class="hs-inrow"><label><span class="var">baseH</span><span class="desc">Straight body height (sH)</span></label><span><input type="number" id="baseH" value="30" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
