...
function initLayout(phpData) {
    ...
    + '    <div class="page-view" id="page-draw-psc"><h1 class="page-heading">PSC Box Girder</h1><div class="breadcrumb"><a href="#">Home</a> / <span>PSC</span></div><div id="mount-draw-psc"></div></div>'
