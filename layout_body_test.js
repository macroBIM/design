...
function initLayout(phpData) {
    ...
    + '      <a href="#" data-page="bendradius">철근 절곡 곡선반경</a>'
    + '    </div>'
    ...
    + '      <h1 class="page-heading">철근 절곡 시 곡선반경</h1>'
    + '      <div class="breadcrumb"><a href="#">Home</a> / <a href="#">Tables</a> / <span>철근 절곡 곡선반경</span></div>'
    + '      <div class="table-card">'
    + '        <div class="table-card-header"><div class="table-card-title">주철근 (표준갈고리)</div><div class="table-card-desc">구부림 최소 내면 <b>지름</b> ( 괄호 = 반지름 )</div></div>'
    + '        <div style="overflow-x:auto;"><table class="ea-table striped rebar">'
    + '          <thead>'
    + '            <tr><th rowspan="2">철근 크기</th><th colspan="2">ACI 계열</th><th colspan="2">유로코드 계열 (한계상태)</th></tr>'
    + '            <tr><th>KDS 14 20 50</th><th>AASHTO LRFD</th><th>KDS 24 14 21</th><th>EN 1992-1-1</th></tr>'
    + '          </thead>'
    + '          <tbody>'
    + '            <tr><td>D16 이하<br><span style="color:#94a3b8;font-size:11px;">#5 / &le;16mm</span></td><td>6d<sub>b</sub> (3d<sub>b</sub>)</td><td>6d<sub>b</sub> (3d<sub>b</sub>)</td><td>4d<sub>b</sub> (2d<sub>b</sub>)</td><td>4d<sub>b</sub> (2d<sub>b</sub>)</td></tr>'
    ...
    + '            <tr><td>D38 이상<br><span style="color:#94a3b8;font-size:11px;">#14~ / 40mm~</span></td><td>10d<sub>b</sub> (5d<sub>b</sub>)</td><td>10d<sub>b</sub> (5d<sub>b</sub>)</td><td>7d<sub>b</sub> (3.5d<sub>b</sub>)</td><td>7d<sub>b</sub> (3.5d<sub>b</sub>)</td></tr>'
    + '          </tbody>'
    + '        </table></div>'
    + '      </div>'
    + '      <div class="table-card">'
    + '        <div class="table-card-header"><div class="table-card-title">전단보강근 (스터럽 / 띠철근)</div><div class="table-card-desc">구부림 최소 내면 <b>지름</b> ( 괄호 = 반지름 )</div></div>'
    + '        <div style="overflow-x:auto;"><table class="ea-table striped rebar">'
    + '          <thead>'
    + '            <tr><th rowspan="2">철근 크기</th><th colspan="2">ACI 계열</th><th colspan="2">유로코드 계열 (한계상태)</th></tr>'
    + '            <tr><th>KDS 14 20 50</th><th>AASHTO LRFD</th><th>KDS 24 14 21</th><th>EN 1992-1-1</th></tr>'
    + '          </thead>'
    + '          <tbody>'
    + '            <tr><td>D16 이하<br><span style="color:#94a3b8;font-size:11px;">#5 / &le;16mm</span></td><td>4d<sub>b</sub> (2d<sub>b</sub>)</td><td>4d<sub>b</sub> (2d<sub>b</sub>)</td><td>4d<sub>b</sub> (2d<sub>b</sub>)</td><td>4d<sub>b</sub> (2d<sub>b</sub>)</td></tr>'
    + '            <tr><td>D19 ~ D25<br><span style="color:#94a3b8;font-size:11px;">#6~8 / 20~25mm</span></td><td>6d<sub>b</sub> (3d<sub>b</sub>)</td><td>6d<sub>b</sub> (3d<sub>b</sub>)</td><td>7d<sub>b</sub> (3.5d<sub>b</sub>)</td><td>7d<sub>b</sub> (3.5d<sub>b</sub>)</td></tr>'
    + '          </tbody>'
    + '        </table></div>'
    + '      </div>'
    + '      <div style="font-size:12px;color:#64748b;line-height:1.7;padding:2px 4px;">'
    + '        &bull; 표 값은 구부림 <b>최소 내면 지름</b>, 괄호는 <b>반지름</b>(지름/2) 입니다.<br>'
    + '        &bull; ACI 계열(KDS 14 20 50 &middot; AASHTO)은 철근 크기별, 유로코드 계열(도로교 KDS 24 14 21 &middot; EN 1992-1-1)은 지름 &le;16 / &gt;16 기준입니다.<br>'
    + '        &bull; US(#)&middot;EU(mm) 호칭은 근사 참고값입니다.<br>'
    + '        &bull; 유로코드/도로교 값은 철근 손상방지 기준(EN 1992 표 8.1N)으로, 갈고리 내부 콘크리트 지압 검토 시 더 큰 값이 필요할 수 있습니다.'
    + '      </div>'
    + '    </div>'
