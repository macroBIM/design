...
function _createTemplates() {
    ...
    _addTemplate(root, 'tpl-draw-liftinglug', _HSCSS()
      ...
      + '      <div class="hs-batch-wrap"><div class="hs-batch-lbl">Batch Input (CSV) <span class="hs-batch-hint">lugW,lugH,baseH,outerR,innerR,padeyeR,lugT,padeyeT,ecc,bodyExt,bpW,bpT,bpL,spBotL,spTopL,spHL,spWL,spInsetL,spBotR,spTopR,spHR,spWR,spInsetR</span></div>'
