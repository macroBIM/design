...
function initLayout(phpData) {
    ...
    + '        <div style="border-top:1px solid #e0e7f1;margin-top:32px;padding:28px 0;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:16px;">'
    + '          <div>'
    ...
    + '        </div>'
    + '        <div style="text-align:center;padding:12px 0 20px;font-size:11px;color:#94a3b8;">&copy; 2026 macroBIM. All rights reserved.</div>'
    + '      </div>'
    + '    </div>'
