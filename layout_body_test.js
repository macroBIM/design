...
function _createTemplates() {
    ...
    _addTemplate(root, 'tpl-draw-liftinglug', _HSCSS()
      ...
      + '      <div class="hs-batch-lbl" style="margin-top:12px;display:flex;justify-content:space-between;align-items:center">Eccentricity &amp; extension<input type="checkbox" id="eccOn" checked onchange="fdraw_liftinglug()" style="width:16px;height:16px;margin:0;accent-color:var(--dim)"></div>'
      ...
      + '        </div>'
      + '        <div style="flex:1;min-width:0">'
      + '      <div class="hs-batch-lbl" style="margin-top:2px;display:flex;justify-content:space-between;align-items:center">Side plates<input type="checkbox" id="spOn" onchange="fdraw_liftinglug()" style="width:16px;height:16px;margin:0;accent-color:#a855f7"></div>'
...
function _bindNavigation() {
    ...
    function ensurePscbox() {
        ...
        var sc = document.createElement('script');
        sc.src = 'https://macrobim.github.io/macroBIM/bim_pscbox_test.js?v=25';
