...
function _createTemplates() {
    ...
    _addTemplate(root, 'tpl-draw-liftinglug', _HSCSS()
      ...
      + '        </div>'
      + '        <div style="flex:1;min-width:0">'
      + '      <div class="hs-batch-lbl" style="margin-top:2px;display:flex;align-items:center;gap:8px"><input type="checkbox" id="spOn" onchange="fdraw_liftinglug()" style="width:16px;height:16px;margin:0;accent-color:#a855f7">Side plates</div>'
      ...
      + '        </div>'
      + '      <div class="hs-batch-lbl" style="margin-top:12px;display:flex;align-items:center;gap:8px"><input type="checkbox" id="bpOn" checked onchange="fdraw_liftinglug()" style="width:16px;height:16px;margin:0;accent-color:var(--dim)">Base plate</div>'
