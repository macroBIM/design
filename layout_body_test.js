...
function _createTemplates() {
    ...
    _addTemplate(root, 'tpl-draw-liftinglug', _HSCSS()
      ...
      + '    <div class="hs-inputs">'
      + '      <div class="hs-batch-wrap"><div class="hs-batch-lbl">Batch Input (CSV) <span class="hs-batch-hint">lugW,lugH,baseH,outerR,innerR,padeyeR,lugT,padeyeT,ecc,bodyExt,bpW,bpT,bpL,weldLugSize,weldPadSize,weldBaseSize,spT,spH,spW</span></div>'
      + '        <textarea class="hs-batch" id="sUserText" rows="2" spellcheck="false" onchange="putParams_lug_test(\'sUserText\'); fdraw_liftinglug();">120,120,30,40,10,30,20,40,0,0,220,24,90,10,6,8,12,90,90</textarea></div>'
      ...
      + '      <div class="hs-inrow"><label><span class="var">padeye</span><span class="desc"></span></label><span><input type="checkbox" id="padOn" checked onchange="fdraw_liftinglug()" style="width:18px;height:18px;vertical-align:middle;accent-color:var(--dim)"></span></div>'
      ...
      + '      <div class="hs-inrow" id="row_spT"><label><span class="var">spT</span><span class="desc">Side plate thickness (each)</span></label><span><input type="number" id="spT" value="12" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
      + '      <div class="hs-inrow" id="row_spH"><label><span class="var">spH</span><span class="desc">Side plate height</span></label><span><input type="number" id="spH" value="90" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
      + '      <div class="hs-inrow" id="row_spW"><label><span class="var">spW</span><span class="desc">Side plate width</span></label><span><input type="number" id="spW" value="90" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
      ...
      + '      <div class="hs-batch-lbl" style="margin-top:10px">Base plate</div>'
      + '      <div class="hs-inrow"><label><span class="var">bpOn</span><span class="desc">Base plate</span></label><span><select id="bpOn" style="width:120px;padding:5px 8px;border:1px solid var(--line);border-radius:6px;background:var(--panel);color:var(--ink);font-size:13px" onchange="fdraw_liftinglug()"><option value="plate" selected>Plate</option><option value="none">None</option></select></span></div>'
      + '      <div class="hs-inrow"><label><span class="var">bpMode</span><span class="desc">Plate length mode</span></label><span><select id="bpMode" style="width:120px;padding:5px 8px;border:1px solid var(--line);border-radius:6px;background:var(--panel);color:var(--ink);font-size:13px" onchange="fdraw_liftinglug()"><option value="infinite" selected>Infinite (break)</option><option value="finite">Finite (drawn)</option></select></span></div>'
      + '      <div class="hs-inrow"><label><span class="var">bpW</span><span class="desc">Base plate width B (front)</span></label><span><input type="number" id="bpW" value="220" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
      + '      <div class="hs-inrow"><label><span class="var">bpT</span><span class="desc">Base plate thickness</span></label><span><input type="number" id="bpT" value="24" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
      + '      <div class="hs-inrow"><label><span class="var">bpL</span><span class="desc">Base plate length C (side)</span></label><span><input type="number" id="bpL" value="90" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
...
function _bindNavigation() {
    ...
    function ensureLugTest(cb) { ensureRWModule('bim_liftinglug_test.js?v=6', 'lugTest', cb); }
