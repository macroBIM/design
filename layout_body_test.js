...
function initLayout(phpData) {
    ...
    + '          <div style="background:#fff;border:1px solid #e0e7f1;border-radius:12px;padding:24px;">'
    + '            <div style="font-size:26px;color:#2563eb;margin-bottom:12px;"><i class="bi bi-rulers"></i></div>'
    ...
    + '          <div style="background:#fff;border:1px solid #e0e7f1;border-radius:10px;padding:14px;"><div style="font-size:17px;color:#f59e0b;margin-bottom:6px;"><i class="bi bi-grid-3x3"></i></div><h4 style="font-size:13px;font-weight:600;color:#0f172a;margin:0 0 3px;">Rebar Tables</h4><p style="font-size:11.5px;color:#64748b;margin:0;">KS D 3504 · ASTM A615M · BS 4449</p></div>'
    + '          <div style="background:#fff;border:1px solid #e0e7f1;border-radius:10px;padding:14px;"><div style="font-size:17px;color:#f59e0b;margin-bottom:6px;"><i class="bi bi-grid-3x3"></i></div><h4 style="font-size:13px;font-weight:600;color:#0f172a;margin:0 0 3px;">Steel Strength</h4><p style="font-size:11.5px;color:#64748b;margin:0;">Steel material strength properties</p></div>'
    + '          <div style="background:#fff;border:1px solid #e0e7f1;border-radius:10px;padding:14px;"><div style="font-size:17px;color:#f59e0b;margin-bottom:6px;"><i class="bi bi-grid-3x3"></i></div><h4 style="font-size:13px;font-weight:600;color:#0f172a;margin:0 0 3px;">Steel Section Tables</h4><p style="font-size:11.5px;color:#64748b;margin:0;">H-Section, Channel, Angle, Tube, Pipe — 7 types</p></div>'
    + '          <div style="background:#fff;border:1px solid #e0e7f1;border-radius:10px;padding:14px;"><div style="font-size:17px;color:#f59e0b;margin-bottom:6px;"><i class="bi bi-grid-3x3"></i></div><h4 style="font-size:13px;font-weight:600;color:#0f172a;margin:0 0 3px;">Rebar Bend Radius</h4><p style="font-size:11.5px;color:#64748b;margin:0;">ACI · AASHTO · Eurocode · KDS</p></div>'
    + '          <div style="background:#fff;border:1px solid #e0e7f1;border-radius:10px;padding:14px;"><div style="font-size:17px;color:#8b5cf6;margin-bottom:6px;"><i class="bi bi-rulers"></i></div><h4 style="font-size:13px;font-weight:600;color:#0f172a;margin:0 0 3px;">Anchorage / Splice</h4><p style="font-size:11.5px;color:#64748b;margin:0;">Eurocode-based anchorage and splice length calculator</p></div>'
    + '        </div>'
    + '        <h2 style="font-size:20px;font-weight:700;color:#0f172a;margin:0 0 6px;">Parametric Sections &amp; Structures</h2>'
    + '        <p style="font-size:13px;color:#64748b;margin:0 0 16px;">Pier, Retaining Walls (Gravity / Inverted-T / L-shaped), H Section, Channel, I Beam, BOX 1-Cell, Circle, Octagon, Track, Rect, Bolt Splice, Lifting Lug — multi-view 3D parametric drawings with batch CSV input and DXF export</p>'
    ...
    + '        <div style="background:#0c1222;padding:32px;border-radius:14px;margin-top:32px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:20px;">'
    + '          <div>'
    + '            <h2 style="font-size:20px;font-weight:700;color:#e8edf6;margin:0 0 6px;">Get in Touch</h2>'
    + '            <p style="font-size:13px;color:#8899b4;margin:0;max-width:400px;line-height:1.6;">Questions, feedback, or collaboration — reach out anytime.</p>'
    + '          </div>'
    + '          <a href="http://www.macrobim.com" style="display:flex;align-items:center;gap:8px;font-size:13px;color:#e8edf6;text-decoration:none;"><i class="bi bi-globe2" style="color:#2563eb;"></i> www.macrobim.com</a>'
    + '        </div>'
    + '        <div style="text-align:center;padding:20px 0;font-size:11px;color:#64748b;">&copy; 2026 macroBIM. All rights reserved.</div>'
    + '      </div>'
    + '    </div>'
...
function _createTemplates() {
    ...
    _addTemplate(root, 'tpl-draw-liftinglug', _HSCSS()
      ...
      + '      <div class="hs-batch-lbl" style="margin-top:12px;display:flex;justify-content:space-between;align-items:center">Padeye<input type="checkbox" id="padOn" checked onchange="fdraw_liftinglug()" style="width:16px;height:16px;margin:0;accent-color:var(--dim)"></div>'
      ...
      + '      <div class="hs-batch-lbl" style="margin-top:12px;display:flex;justify-content:space-between;align-items:center">Base plate<input type="checkbox" id="bpOn" checked onchange="fdraw_liftinglug()" style="width:16px;height:16px;margin:0;accent-color:var(--dim)"></div>'
      ...
      + '      <div class="hs-inrow" id="row_bpW"><label><span class="var">bpW</span><span class="desc">Base plate width B (front)</span></label><span><input type="number" id="bpW" value="220" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
      ...
      + '      <div class="hs-inrow" id="row_bpL"><label><span class="var">bpL</span><span class="desc">Base plate length C (side)</span></label><span><input type="number" id="bpL" value="90" onchange="fdraw_liftinglug()"><span class="hs-unit">mm</span></span></div>'
      + '      <div class="hs-batch-lbl" style="margin-top:10px">Welds &mdash; check to apply, then type &amp; size</div>'
